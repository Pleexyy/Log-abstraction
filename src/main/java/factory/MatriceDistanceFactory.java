...
public class MatriceDistanceFactory {
    ...
    public static Matrix createMatrixDistance(Tableau t, List<SessionAbstract> sessionAbstracts, final int lookback, final double facteurAttenuation) {
        return createMatrixDistance(t, sessionAbstracts, lookback, 1, facteurAttenuation);
    }

    public static Matrix createMatrixDistance(Tableau t, List<SessionAbstract> sessionAbstracts, final int lookback, final int incrementValue, final double facteurAttenuation) {
